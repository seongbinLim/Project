...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		buffer.append("		<a href=\"javascript:pageMove(1);\" class=\"page-link\">최신</a></li> \n");
		buffer.append("	<li class=\"page-item\"> \n");
		buffer.append("		<a href=\"javascript:pageMove(" + (this.startRange ? 1 : (startPage - 1)) + ");\" class=\"page-link\">이전</a> </li>\n");
		for(int i = startPage; i <= endPage; i++) {
			buffer.append("	<li class=\"" + (currentPage == i ? "page-item active" : "page-item")+"\">\n");
			buffer.append("		<a href=\"javascript:pageMove(" + i + ");\" class=\"page-link\">" + i + "</a></li> \n");
		}
		buffer.append("	<li class=\"page-item\"> \n");
		buffer.append("		<a href=\"javascript:pageMove(" + (this.endRange ? endPage : (endPage + 1)) + ");\" class=\"page-link\">다음</a> </li>\n");
		buffer.append("	<li class=\"page-item\"> \n");
		buffer.append("		<a href=\"javascript:pageMove(" +  + totalPageCount + ");\" class=\"page-link\">마지막</a> </li>\n");
		buffer.append("</ul> \n");
